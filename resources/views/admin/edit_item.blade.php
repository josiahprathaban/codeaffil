                ...
                <form method="POST" action="{{ route('product.update')}}" name="item">
                    ...
                    <div class="card card-block">
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input type="text" name="title" class="form-control boxed" value="{{$product->title}}" placeholder="">
                            </div>
                        </div>
                        <div class="form-group row">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control boxed" value="{{$product->regular_price}}" name="regular_price" placeholder="">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label class="col-sm-2 form-control-label text-xs-right"> Sale Price: </label>
                            <div class="col-sm-10">
                                <input type="text" class="form-control boxed" name="sale_price" value="{{$product->sale_price}}" placeholder="">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label class="col-sm-2 form-control-label text-xs-right"> Affiliate Link: </label>
                            <div class="col-sm-10">
                                <input type="text" class="form-control boxed" name="affiliate_link" value="{{$product->affiliate_link}}" placeholder="">
                            </div>
                        </div>
                        <div class="form-group row">
                        ...
                        <div class="card card-block sameheight-item">
                            <form role="form">
                                <div class="form-group">
                                    ...
                                    <input type="email" class="form-control" id="exampleInputEmail1" placeholder="Enter Brand Name">
                                </div>
                                <div class="form-group">
                                    <button type="submit" class="btn btn-primary">Add</button>
                                </div>
