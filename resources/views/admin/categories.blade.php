                                                                    ...
                                                                    <div class="item-actions-dropdown">
                                                                        ...
                                                                        <div class="item-actions-block">
                                                                            <ul class="item-actions-list">
                                                                                <li>
                                                                                    <a class="remove" href="/delete-brand/" data-toggle="modal" data-target="#confirm-modal-{{$category->id}}">
                                                                                            ...
                                                                                            <div class="modal-content">
                                                                                                ...
                                                                                                <div class="card card-block sameheight-item">
                                                                                                        <form role="form" method="post" action="{{ route('category.update')}}">
                                                                                                            ...
                                                                                                            <div class="form-group">
                                                                                                                <label for="exampleInputEmail1">Brand</label>
                                                                                                                <input type="text" class="form-control"  value="{{$category->name}}" id="exampleInputEmail1" name="brand_name" placeholder="Enter Category Name"> </div>
                                                                                                            <div class="form-group">
                            ...
                            <div class="card card-block sameheight-item">
                                    <form role="form" method="post" action="{{ route('category.addsubmit')}}">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="exampleInputEmail1" name="category_name" placeholder="Enter Categories Name"> </div>
                                        <div class="form-group">
                                            <button type="submit" class="btn btn-primary">Add</button>
                                        </div>
                                    </form>
