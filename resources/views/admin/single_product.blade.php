                    ...
                    <form name="item">
                        <div class="card card-block">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" name="title" class="form-control boxed" value="{{$product->title}}" placeholder="" disabled> </div>
                            </div>
                            <div class="form-group row">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control boxed" value="{{$product->regular_price}}"  name="regular_price" placeholder="" disabled> </div>
                            </div>
                            <div class="form-group row">
                                <label class="col-sm-2 form-control-label text-xs-right"> Sale Price: </label>
                                <div class="col-sm-10">
                                    <input type="text" class="form-control boxed" name="sale_price" value="{{$product->sale_price}}" placeholder="" disabled> </div>
                            </div>
                            <div class="form-group row">
                                <label class="col-sm-2 form-control-label text-xs-right"> Affiliate Link: </label>
                                <div class="col-sm-10">
                                    <input type="text" class="form-control boxed" name="affiliate_link" value="{{$product->affiliate_link}}"  placeholder="" disabled> </div>
                            </div>
                            <div class="form-group row">
