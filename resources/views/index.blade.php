...
<body>
        ...
        <section class="categorie-area mt-5" id="shopnow">
            <div class="container">
                ...
                <div class="category-slider owl-carousel owl-nav-style">
                    <!-- Single item -->
                    @for($i = 0; $i < count($popularCategories); $i+=2) <div class="category-item">
    ...
    <section class="feature-area mt-5">
        <div class="container">
            ...
            <div class="feature-slider owl-carousel owl-nav-style">
                <!-- Single Item -->
                @for($i = 0; $i < count($suggestedProducts); $i+=2) <div class="feature-slider-item">
                    ...
                    @if($i+1 < count($suggestedProducts)) <article class="list-product">
                        <div class="img-block">
            ...
            <div class="row">
                ...
                <div class="col-xs-12 col-sm-12 col-md-7 col-lg-7 col-xl-8">
                    ...
                    <div class="new-product-slider owl-carousel owl-nav-style">
                        <!-- Product Single Item -->
                        @for($i = 0; $i < count($newProducts); $i+=2) <div class="product-inner-item">
                            ...
                            @if($i+1 < count($newProducts)) <article class="list-product">
                                <div class="img-block" style="display: flex; align-items: center; justify-content: center; height:210px;">
    ...
    <section class="feature-area mt-5">
        <div class="container">
            ...
            <div class="feature-slider owl-carousel owl-nav-style">
                <!-- Single Item -->
                @for($i = 0; $i < count($saleProducts); $i+=2) <div class="feature-slider-item">
                    <article class="list-product">
                        <div class="img-block">
                    ...
                    @if($i+1 < count($saleProducts)) <article class="list-product">
                        <div class="img-block">
